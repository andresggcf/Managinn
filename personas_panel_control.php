          ...
          <div class="col-12 py-4 padding-panel">
            ...
            <div class="row">
              ...
              <div class="col-4 my-3">
                <div class="datos box-shadow d-flex flex-column justify-content-start">
                  ...
                  <div class="row">
                    <div class="col-4">
                      <div class="box-shadow">
                        ...
                        <span>17/feb/19 - 30/feb/19</span>
                      </div>
                    </div>
                    <div class="col-4 d-flex">
                      <div class="border-radius">
                        <img src="img/iconos/icono_anadir.svg" style="height: 15px;margin: 30px auto;display: block;" alt="">
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-5 my-3">
                <div class="perfil_creativo box-shadow ">
                  <h4><img src="img/iconos/perfilcreativo.svg" style="height: 26px;" alt=""> Perfil Creativo</h4>
                  <div class="row">
